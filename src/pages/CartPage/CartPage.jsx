...
import { clearCart, getAllCarts, getCartTotal, removeFromCart, toggleCartQty } from '../../redux/cartSlice';
    ...
    return (
      <div className='container my-5'>
        <div className='empty-cart flex justify-center align-center flex-column font-manrope'>
          ...
          <NavLink to = "/" className='shopping-btn bg-orange text-white fw-5'>Go shopping Now</NavLink>
        </div>
      </div>
    )
  }
                  ...
                  <div className='cart-ctr py-4' key = {cart?.id}>
                    ...
                    <div className='cart-ctd'>
                      <div className='qty-change flex align-center'>
                        <button type = "button" className='qty-decrease flex align-center justify-center' onClick={() => decHandler({id: cart?.id, type: "DEC"}) }>
                        ...
                        <button type = "button" className='qty-increase flex align-center justify-center' onClick={() => incHandler({id: cart?.id, type: "INC"})  }>
                    ...
                    <div className='cart-ctd'>
                      <button type = "button" className='delete-btn text-dark ' onClick={() => deleteHandler({id:cart?.id})  }>Delete</button>
                    </div>
                  </div>
                )
              })
